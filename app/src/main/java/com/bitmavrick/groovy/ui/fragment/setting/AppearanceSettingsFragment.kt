...
class AppearanceSettingsFragment : BaseFragment(false) {
    ...
    override fun onCreateView(
        ...
        collapsingToolbar.title = getString(R.string.settings_category_appearance)
        ...
        childFragmentManager
            ...
            .add(R.id.settings, AppearanceSettingsTopFragment())
            .commit()
